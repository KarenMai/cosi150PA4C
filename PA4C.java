/* Generated By:JavaCC: Do not edit this line. PA4C.java */
import syntaxtree.*;

public class PA4C implements PA4CConstants {

  /** Main entry point. */
  public static void main(String args[]) {
    PA4C t = new PA4C(System.in);
    try {
      Program n = t.Start();
...
/* Program Syntax */
 ...
 Exp b;
  ...
  static public PA4CTokenManager token_source;
  ...
  public PA4C(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public PA4C(java.io.InputStream stream, String encoding) {
    ...
    token_source = new PA4CTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public PA4C(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public PA4C(PA4CTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(PA4CTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
